...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CracklingWorks — Premium Sivakasi Crackers" },
      { name: "description", content: "Premium Sivakasi crackers — sparklers, rockets, sky shots & gift boxes at flat 70% off MRP." },
